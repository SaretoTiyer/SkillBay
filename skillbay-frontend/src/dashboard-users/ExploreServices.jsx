            ...
            <div className="flex flex-col overflow-y-auto overscroll-contain">
              ...
              <div className="p-5 sm:p-6 lg:p-8 lg:w-1/2 lg:ml-auto">
                ...
                <div className="bg-linear-to-br from-blue-50 to-indigo-50 rounded-xl sm:rounded-2xl p-4 sm:p-5 mb-5 sm:mb-6 border border-blue-100">
                  <p className="text-xs sm:text-sm text-gray-500 mb-1">Precio del servicio</p>
                ...
                <div className="space-y-3 sm:space-y-4 mb-5 sm:mb-6">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900">Detalles del servicio</h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="font-semibold text-gray-900 text-sm truncate">{selectedItem.cliente_usuario?.ciudad || "Remoto"}</p>
                      </div>
                    </div>
