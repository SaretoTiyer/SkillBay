...
class CategoriaSeeder extends Seeder
{
    public function run(): void
    {
        $categorias = [
            ...
            ['id_Categoria' => 'tec_desarrollo_mobile', 'nombre' => 'Desarrollo Mobile', 'grupo' => 'Tecnologia', 'descripcion' => 'Desarrollo de aplicaciones móviles para iOS y Android.', 'imagen' => 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=800&q=80'],
            ['id_Categoria' => 'tec_diseno_ui_ux', 'nombre' => 'Diseño UI/UX', 'grupo' => 'Tecnologia', 'descripcion' => 'Diseño de interfaces y experiencia de usuario.', 'imagen' => 'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=800&q=80'],
            ['id_Categoria' => 'tec_diseno_grafico', 'nombre' => 'Diseño Gráfico', 'grupo' => 'Tecnologia', 'descripcion' => 'Diseno visual, branding y piezas digitales.', 'imagen' => 'https://images.unsplash.com/photo-1626785774573-4b799315345d?w=800&q=80'],
            ['id_Categoria' => 'tec_soporte_tecnico', 'nombre' => 'Soporte Técnico', 'grupo' => 'Tecnologia', 'descripcion' => 'Soporte y mantenimiento tecnologico.', 'imagen' => 'https://images.unsplash.com/photo-1587620962725-abab7fe55159?w=800&q=80'],
            ...
            ['id_Categoria' => 'tec_redes_seguridad', 'nombre' => 'Redes y Seguridad', 'grupo' => 'Tecnologia', 'descripcion' => 'Configuración de redes y seguridad informática.', 'imagen' => 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&q=80'],
            ['id_Categoria' => 'tec_data_science', 'nombre' => 'Data Science', 'grupo' => 'Tecnologia', 'descripcion' => 'Análisis de datos y machine learning.', 'imagen' => 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80'],
            ...
            ['id_Categoria' => 'sg_recursos_humanos', 'nombre' => 'Recursos Humanos', 'grupo' => 'Servicios Generales', 'descripcion' => 'Gestion de talento y nomina.', 'imagen' => 'https://images.unsplash.com/photo-1553877522-43269d4ea984?w=800&q=80'],
            ...
            ['id_Categoria' => 'sg_ingenieria', 'nombre' => 'Ingenieria', 'grupo' => 'Servicios Generales', 'descripcion' => 'Servicios de ingenieria y proyectos.', 'imagen' => 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=800&q=80'],
